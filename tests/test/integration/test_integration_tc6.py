...
class TestCreateDeleteUpdateBooking(object):
    @pytest.fixture()
    def create_token(self):
        ...
        return token
    @allure.title("Verify Create, Delete and Update the deleted Booking")
    @allure.description("Creating a Booking , delete the booking and try to update the deleted booking")
